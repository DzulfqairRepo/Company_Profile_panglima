...
<body class="bg-gray-50">
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
         <h2 class="text-4xl font-bold text-center text-blue-600 mb-12">Vision & Mission</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-2xl font-bold text-blue-600 mb-4 text-center">Vision</h3>
                <p class="text-gray-600 text-justify">To become a preferred and competent fishery supplier of Aceh, Indonesia by carrying out the principle of trust & integrity with mastering domestic and foreign marketing sources and networks through human resources and professional management.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                <div class="mb-4 flex justify-center">
                    <svg class="w-16 h-16 text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-600 mb-2 text-center">The company is officially established</h3>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-blue-600 mb-4 text-center">2007-2010</h4>
                </div>
                <div>
                    <p class="text-gray-600 text-justify">The company is established by two experts with its aim to be reliable partners in logistic field to help Aceh government in reconstruct Aceh's city after a catastrophic tsunami hit that region in 2004.</p>
                </div>
            </div>
                        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                <div class="mb-4 flex justify-center">
                    <svg class="w-16 h-16 text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-600 mb-2 text-center">Fisheries Export</h3>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-blue-600 mb-4 text-center">2010-2012</h4>
                </div>
                <div>
                    <p class="text-gray-600 text-justify">We exported lobster, fresh fish & grouper fish seed to Asia market by air in total around 150,000 fish during this period.</p>
                </div>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                <div class="mb-4 flex justify-center">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-600 mb-2 text-center">Expansion Phase</h3>
                </div>
                <div>
                    <h4 class="text-lg font-bold text-blue-600 mb-4 text-center">2018-2020</h4>
                </div>
                <div>
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        <h2 class="text-4xl font-bold text-center text-blue-600 mb-12">Market Infographic</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <div class="mb-4">
                    <h4 class="text-lg font-bold text-blue-600 mb-2 text-center">2010-2012</h4>
                    <h3 class="text-xl font-bold text-blue-600 mb-4 text-center">Malaysia, Singapore, Thailand</h3>
                </div>
                <div>
                    <p class="text-gray-600 text-justify">Around 150,000 seed grouper fish and other fresh fish were exported to those countries.</p>
                </div>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                <div class="mb-4 flex justify-center">
                ...
                <div class="mb-4">
                    <h4 class="text-lg font-bold text-blue-600 mb-2 text-center">2018-2019</h4>
                    <h3 class="text-xl font-bold text-blue-600 mb-4 text-center">Indonesia Market</h3>
                </div>
                <div>
                    <p class="text-gray-600 text-justify">Due to the high demand of decorative fish, we aim to be a leading market in decorative fish with a weekly basis 500 fish for a year.</p>
                </div>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                <div class="mb-4 flex justify-center">
                ...
                <div class="mb-4">
                    <h4 class="text-lg font-bold text-blue-600 mb-2 text-center">2020</h4>
                    <h3 class="text-xl font-bold text-blue-600 mb-4 text-center">Turkey</h3>
                </div>
                <div>
                    <p class="text-gray-600 text-justify">We expand our market to global scale and we successfully exported 3,426 raw bamboo poles to Turkey, CIF Izmir port, from Pidie, Aceh, Indonesia in the beginning of this year.</p>
                </div>
            </div>
        </div>
    </section>
