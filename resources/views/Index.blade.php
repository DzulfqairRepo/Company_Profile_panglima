...
<body class="bg-gray-50">
    ...
    <section class="relative bg-cover bg-center py-12 md:py-20" style="background-image: url('{{ asset('images/nelayan2.png') }}')">
        ...
        <div class="relative max-w-screen-xl mx-auto px-4 text-center text-white">
            <img src="{{ asset('images/Company_Logo.jpeg') }}" alt="TATA NIAGA LESTARI logo" class="h-40 w-40 md:h-80 md:w-80 object-cover rounded-full mx-auto mb-4 md:mb-6">
            <h1 class="text-3xl md:text-5xl font-bold mb-3 md:mb-4">Tata Niaga Lestari Company</h1>
            <p class="text-sm md:text-xl mb-6 md:mb-8 px-2">Tata Niaga Lestari Work Export, Import and Trading By applying the advanced technology and High Quality Product, we are committed to providing the best quality seafood & Agriculture product by operating strict practices of food hygiene, sanitation and quality control</p>
        </div>
    </section>
