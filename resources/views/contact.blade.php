...
<body class="bg-gray-50">
        ...
        <div class="max-w-screen-xl flex items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="flex flex-col md:flex-row md:space-x-8">
                    ...
                    <li><a href="{{ route('contact') }}" class="font-bold text-gray-700 hover:text-blue-600 text-blue-600">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="relative bg-cover bg-center py-20" style="background-image: url('{{ asset('images/nelayan2.png') }}')">
        ...
        <div class="relative max-w-screen-xl mx-auto px-4 text-center text-white z-10">
            ...
            <p class="text-xl">Get in Touch with Panglima Laut Fresh Frozen</p>
        </div>
    </section>

    <!-- Contact Information Section -->
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        <h2 class="text-4xl font-bold text-center text-blue-600 mb-12">Contact Information</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-2xl font-bold text-blue-600 mb-4 text-center">Address</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-2xl font-bold text-blue-600 mb-4 text-center">Phone</h3>
                <div class="text-gray-600 text-center">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-2xl font-bold text-blue-600 mb-4 text-center">Email</h3>
                <div class="text-gray-600 text-center">
                    <p class="font-semibold mb-2">Company Email</p>
                    <p class="mb-4 break-all">tataniagalestari@gmail.com</p>
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        <h2 class="text-4xl font-bold text-center text-blue-600 mb-12">Send us a Message</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md">
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="5" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 resize-none"></textarea>
                    </div>
            ...
            <div class="space-y-6">
                <!-- Office Hours -->
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <h3 class="text-2xl font-bold text-blue-600 mb-6">Office Hours</h3>
                    <div class="space-y-3">
                ...
                <!-- Quick Links -->
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <h3 class="text-2xl font-bold text-blue-600 mb-6">Connect With Us</h3>
                    <div class="space-y-4">
                        <a href="#" class="flex items-center text-gray-700 hover:text-blue-600 transition">
                            <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            <span>Facebook</span>
                        </a>
                        <a href="#" class="flex items-center text-gray-700 hover:text-blue-600 transition">
                            <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20v-7.21H5.5V9.25h2.79V7.16c0-2.77 1.69-4.28 4.16-4.28 1.18 0 2.2.09 2.49.13v2.88h-1.71c-1.34 0-1.6.64-1.6 1.57v2.05h3.2l-.41 3.54h-2.79V20"/></svg>
                            <span>LinkedIn</span>
                        </a>
                        <a href="#" class="flex items-center text-gray-700 hover:text-blue-600 transition">
                            <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75-2.35 7-5 7-5s-1.1.55-3 1.1"/></svg>
                            <span>Twitter</span>
                        </a>
                    </div>
                </div>
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        <h2 class="text-4xl font-bold text-center text-blue-600 mb-12">Find Us</h2>
        <div class="bg-white p-6 rounded-lg shadow-md overflow-hidden">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.8816387847597!2d95.32119!3d5.552603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x304039c5c5c5c5c5%3A0x5c5c5c5c5c5c5c5c!2sBanda%20Aceh!5e0!3m2!1sen!2sid!4v1234567890" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
