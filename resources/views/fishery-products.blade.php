...
<body class="bg-gray-50">
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20" style="background-image: url('{{ asset('images/nelayan2.png') }}'); background-size: cover; background-position: center;">
        <div class="absolute inset-0 bg-black/40 backdrop-blur-sm"></div>
        <div class="relative max-w-screen-xl mx-auto px-4 text-center z-10">
            <h1 class="text-5xl font-bold mb-4">Fishery Products</h1>
            <p class="text-xl">Premium Quality Seafood & Agriculture Products</p>
        </div>
    </section>
    ...
    <section class="max-w-screen-xl mx-auto px-4 py-16">
        <div class="grid grid-cols-1 gap-8">
            <!-- Products Grid -->
            <div>
                <h2 class="text-3xl font-bold text-blue-600 mb-8">Our Products</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Snapper Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$9.00/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Tiger Grouper Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$8.00/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Red Grouper Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$5.80/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Skipjack Tuna</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$1.80/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Mackerel Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$1.80/kg</span>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Yellowfin Tuna</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Banda Aceh</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$5.40/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Milk Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$1.80/kg</span>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Tiger Shrimp</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$10.80/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Squid</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">5-8 Pcs/kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$6.50/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Vanammei Shrimp</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="mb-4">
                                <div class="space-y-2 mb-3">
                                    <label class="flex items-center">
                                        ...
                                        <span class="text-sm text-gray-600">40 Pcs/kg: <span class="font-bold text-blue-600">$8.60</span></span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="vanammei-price" value="10.80" class="vanammei-price-radio mr-2">
                                        <span class="text-sm text-gray-600">30 Pcs/kg: <span class="font-bold text-blue-600">$10.80</span></span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="vanammei-price" value="13.00" class="vanammei-price-radio mr-2">
                                        <span class="text-sm text-gray-600">20 Pcs/kg: <span class="font-bold text-blue-600">$13.00</span></span>
                                    </label>
                                </div>
                                <input type="number" placeholder="Qty" class="w-full px-2 py-1 border border-gray-300 rounded mb-2">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Black Tiger Shrimp</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">20 Pcs/kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$18.00/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Octopus</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$7.20/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Black Marlin Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$7.20/kg</span>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">White Marlin Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$10.80/kg</span>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Stingray Fish</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$2.50/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Pearl Lobster</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">500gr - 1kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$107.20/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Bamboo Lobster</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">500gr - 1kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$57.20/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">Sand Lobster</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">500gr - 1kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$50.00/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">King Crab - Size A</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">2 Crabs/kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$32.30/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">King Crab - Size B</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">3 Crabs/kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$21.50/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-blue-600 mb-2">King Crab - Size C</h3>
                            <p class="text-gray-600 text-sm mb-2">Fresh & Frozen</p>
                            <p class="text-gray-500 text-xs mb-4">4 Crabs/kg | FOB Aceh Port</p>
                            <div class="flex justify-between items-center mb-4">
                                <span class="text-2xl font-bold text-blue-600">$17.90/kg</span>
                                <input type="number" placeholder="Qty" class="w-16 px-2 py-1 border border-gray-300 rounded">
                            </div>
                            <button class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 add-to-cart">Add to Cart</button>
                        </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    <h3 class="text-xl font-semibold text-blue-600">Shopping Cart</h3>
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b gap-2">
                    <button type="button" class="w-full text-gray-700 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" data-modal-hide="cart-modal">Continue Shopping</button>
                    <button type="button" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Proceed to Checkout</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function showToast(message) {
            ...
            const toastHTML = `
                <div id="${toastId}" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-lg border border-gray-200" role="alert">
                    <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="ml-3 text-sm font-medium">${message}</span>
                    <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8" onclick="removeToast('${toastId}')" aria-label="Close">
        ...
        document.querySelectorAll('.add-to-cart').forEach((button, index) => {
            button.addEventListener('click', function() {
                ...
                // Check if this is Vanammei Shrimp (has radio buttons)
                ...
                if (priceRadios.length > 0) {
                    ...
                    productPrice = parseFloat(productCard.querySelector('.text-2xl').textContent.replace('$', ''));
                }
